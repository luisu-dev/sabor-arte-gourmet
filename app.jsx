...
function WhatsAppContactButton() {
  ...
  const [form, setForm] = useState({ nombre: "", telefono: "", ciudad: "", negocio: "" });
  ...
  function handleSubmit(e) {
    e.preventDefault();
    const msg = `Hola, mi nombre es ${form.nombre}. Mi teléfono de WhatsApp es ${form.telefono}. Me comunico desde ${form.ciudad}. Mi tipo de negocio es: ${form.negocio}.`;
    window.open(`https://wa.me/5219841872094?text=${encodeURIComponent(msg)}`, "_blank");
    setOpen(false);
    setForm({ nombre: "", telefono: "", ciudad: "", negocio: "" });
  }
    ...
    <>
      ...
      {open && (
        <div
          ...
          onClick={(e) => e.target.classList.contains("wa-overlay") && setOpen(false)}
        >
          <div className="wa-modal">
            <button className="promo-close" onClick={() => setOpen(false)} aria-label="Cerrar">×</button>
            ...
            <div className="wa-modal-header">
              ...
              <div>
                <h3 className="wa-modal-title">Contáctanos por WhatsApp</h3>
                <p className="wa-modal-sub">Cuéntanos sobre tu negocio y te asesoramos</p>
              </div>
            </div>
            ...
            <form className="wa-modal-form" onSubmit={handleSubmit}>
              ...
              <div className="form-group">
                <label htmlFor="wa-telefono">Teléfono de WhatsApp</label>
                <input
                  id="wa-telefono"
                  name="telefono"
                  type="tel"
              ...
              <div className="form-group">
                ...
                <input
                  ...
                  name="ciudad"
                  type="text"
                  placeholder="¿Desde qué ciudad nos contactas?"
                  value={form.ciudad}
                  onChange={handleChange}
                  required
                />
              ...
              <div className="form-group">
                <label htmlFor="wa-negocio">Tipo de negocio</label>
                <input
                  id="wa-negocio"
                  name="negocio"
                  type="text"
                  placeholder="Ej. restaurante, hotel, distribuidora…"
                  value={form.negocio}
                  onChange={handleChange}
                  required
                />
              </div>
              <button className="btn wa-submit-btn" type="submit">
    ...
    <>
      ...
      <header className="site-header" id="top">
        ...
        <div className="container utility-bar">
          ...
          <a className="utility-link" href="https://wa.me/5219841872094" target="_blank" rel="noreferrer">
            WhatsApp
          </a>
        </div>
      ...
      <main>
        ...
        <section id="asesoria" className="service-strip container reveal">
          ...
          <div className="service-actions">
            <a className="btn" href="https://wa.me/5219841872094" target="_blank" rel="noreferrer">
        ...
        <div className="container footer-grid">
          <div>
            ...
            <div className="footer-social">
              <a className="social-btn whatsapp" href="https://wa.me/5219841872094" target="_blank" rel="noreferrer" aria-label="WhatsApp">
              ...
              <a className="social-btn facebook" href="https://www.facebook.com/share/1GX7U397wL/" target="_blank" rel="noreferrer" aria-label="Facebook">
